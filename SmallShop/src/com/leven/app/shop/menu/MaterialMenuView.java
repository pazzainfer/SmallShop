...
package com.leven.app.shop.menu;

import com.leven.app.shop.R;
import com.leven.app.shop.menu.MaterialMenuDrawable.IconState;
import com.leven.app.shop.menu.MaterialMenuDrawable.Stroke;
...
public class MaterialMenuView extends View implements MaterialMenu {
	...
	private void init(Context context, AttributeSet attributeSet) {
		...
		try {
			int color = attr.getColor(R.styleable.MaterialMenuView_mm_color, MaterialMenuDrawable.DEFAULT_COLOR);
			int scale = attr.getInteger(R.styleable.MaterialMenuView_mm_scale, MaterialMenuDrawable.DEFAULT_SCALE);
			int transformDuration = attr.getInteger(R.styleable.MaterialMenuView_mm_transformDuration, MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION);
			int pressedDuration = attr.getInteger(R.styleable.MaterialMenuView_mm_pressedDuration, MaterialMenuDrawable.DEFAULT_PRESSED_DURATION);
